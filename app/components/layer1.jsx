    ...
    return (
        <div className="w-full h-[488px] xl:h-[638px] relative pt-[50px] flex justify-between" id="home">
            ...
            <div className="home w-[480px] lg:w-[480px] xl:w-[664px] h-[455px] relative">
                ...
                <div className="home_1 w-[320px] lg:w-[320px] xl:w-[440px] h-[300px] lg:h-[300px] xl:h-[400px] rounded-ss-[32px] rounded-ee-[32px] absolute top-[100px] lg:top-0 xl:top-0 left-[570px lg:left-[570px xl:left-[122px lg:right-[60px] xl:right-[66px] bg-no-repeat bg-right bg-100 lg:bg-100 xl:bg-100 z-10" />

                <div className="home_2 h-[60px] lg:h-[50px] xl:h-[72px] py-2 px-4 lg:py-2 lg:px-4 xl:p-4 bg-white shadow-5xl rounded-lg flex flex-col justify-start items-start gap-6 absolute top-[410px] lg:top-[260px] xl:top-[350px] left-[460px lg:left-[-38px] xl:left-[0px] z-20">
                ...
                <div className="home_3 w-12 lg:w-12 xl:w-16 h-12 lg:h-12 xl:h-16 absolute top-[173px] lg:top-[30px] xl:top-[40px] left-[850px lg:left-[865px xl:left-[539px right-[32px] bg-no-repeat bg-top z-20" />

                <div className="home_4 h-[40px] lg:h-[40px] xl:h-[54px] w-[150px] lg:w-[150px] xl:w-[185px] px-4 py-2 lg:py-1.5 xl:py-2 bg-white shadow-5xl rounded-lg flex flex-col justify-start items-start gap-6 absolute top-[300px] lg:top-[160px] xl:top-[214px] left-[834px lg:left-[833px xl:left-[484px lg:right-[-33px] xl:right-[-40px] z-20">
